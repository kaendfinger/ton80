  ...
  var dart = [["", "FluidMotion.dart",, M, {
    ...
    FluidMotion: {
      ...
      static: {FluidMotion_setupFluidMotion: function() {
        ...
        }, "call$1", "FluidMotion_FluidMotion_prepareFrame$closure", 2, 0, 0]}
    },
    ...
    ListIterator: {
      ...
      moveNext$0: function() {
        ...
        this._current = C.NativeFloat64List_methods.elementAt$1(t1, t2);
        ++this._index;
        return true;
      }
    },
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, v: true, args: [M.Field]}, {func: 1, ret: P.num}];

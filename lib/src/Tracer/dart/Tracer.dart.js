// Generated by dart2js, the Dart to JavaScript compiler version: 1.14.0-edge.a57abe83e2bedefc9d384dcd100eaf2c85a70c1d.
...
(function() {
  ...
  var dart = [["", "Tracer.dart",, D, {
  ...
  }, 1], ["_foreign_helper", "dart:_foreign_helper",, H, {
    "^": "",
    JS_CONST: {
      "^": "Object;code"
    }
    ...
    ListIterator: {
      ...
      moveNext$0: function() {
        ...
        this._current = C.NativeFloat32List_methods.elementAt$1(t1, t2);
        ++this._index;
        return true;
      }
    },
    ...
    renderScene: function($event) {
      ...
      t1.push(new D.Plane(1.2, new D.Vector(0.1, 0.9, -0.5).normalize$0(), C.Chessboard_s8k));
      t1.push(C.Sphere_44Q);
      t1.push(C.Sphere_gsm);
      t2.push(C.Light_ia3);
      t2.push(C.Light_yrN);
    ...
    Engine: {
      ...
      rayTrace$4: function(info, ray, scene, depth) {
        var t1, t2, result, shininess, t3, t4, t5, color, i, t6, light, t7, t8, t9, t10, t11, m, t12, $L, t13, t14, t15, t16, reflectionRay, refl, shadowInfo, dB, m0, glossWeight;
        t1 = info.color;
        ...
        for (t1 = depth <= this.rayDepth, t2 = ray.direction, t3 = t2.x, t4 = t2.y, t2 = t2.z, t5 = depth + 1, color = result, i = 0; t6 = scene.lights, i < t6.length; ++i) {
          ...
          t6 = t6.z;
          t7 = t6 - t7.z;
          m = Math.sqrt(t9 * t9 + t11 * t11 + t7 * t7);
          t9 /= m;
          t11 /= m;
          t7 /= m;
          t12 = info.normal;
          $L = t9 * t12.x + t11 * t12.y + t7 * t12.z;
          if ($L > 0) {
            t12 = info.color;
            t13 = light.color;
            color = new D.Color(color.red + t12.red * (t13.red * $L), color.green + t12.green * (t13.green * $L), color.blue + t12.blue * (t13.blue * $L));
          }
          if (t1)
            if (info.shape.material.reflection > 0) {
              t12 = info.position;
              t13 = info.normal;
              t14 = t13.x;
              t15 = t13.y;
              t13 = t13.z;
              t16 = 2 * -(t14 * t3 + t15 * t4 + t13 * t2);
              reflectionRay = new D.Ray(t12, new D.Vector(t3 + t14 * t16, t4 + t15 * t16, t2 + t13 * t16));
              ...
              t14 = 1 - t13;
              result = new D.Color(color.red * t14 + t12.red * t13, color.green * t14 + t12.green * t13, color.blue * t14 + t12.blue * t13);
              color = result;
            }
          ...
          if (shadowInfo.isHit) {
            ...
            t7 = false;
          if (t7) {
            t7 = shadowInfo.shape.material;
            dB = 0.5 * Math.pow(t7.transparency, 0.5);
          ...
          if (t7) {
            ...
            t10 = t7.y - t10;
            t6 = t7.z - t6;
            m = Math.sqrt(t8 * t8 + t10 * t10 + t6 * t6);
            t7 = scene.camera.position;
            t9 = info.shape.position;
            t11 = t7.x - t9.x;
            t12 = t7.y - t9.y;
            t9 = t7.z - t9.z;
            m0 = Math.sqrt(t11 * t11 + t12 * t12 + t9 * t9);
            t7 = t11 / m0 - t8 / m;
            t10 = t12 / m0 - t10 / m;
            t6 = t9 / m0 - t6 / m;
            m = Math.sqrt(t7 * t7 + t10 * t10 + t6 * t6);
            t8 = info.normal;
            t6 = P.max(t8.x * (t7 / m) + t8.y * (t10 / m) + t8.z * (t6 / m), 0);
            glossWeight = Math.pow(t6, shininess);
            t6 = light.color;
            color = new D.Color(t6.red * glossWeight + color.red, t6.green * glossWeight + color.green, t6.blue * glossWeight + color.blue);
          }
        }
